dir='benchmark-PR-Lacidophilus-all'
mkdir -p $dir
cp parameter_sv_lacidophilus.txt $dir/parameter_sv_lacidophilus.txt
cp parameter_snp.txt $dir/parameter_snp.txt
j=50X
for i in {1..5}
do
  SURVIVOR simSV NC_000913.3.fasta parameter_snp.txt 0.00017 0 $dir/sim_snp_${i}
  SURVIVOR simSV $dir/sim_snp_${i}.fasta parameter_sv_lacidophilus.txt 0 0 $dir/sim_snp_sv_${i}
